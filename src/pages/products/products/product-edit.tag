...
| import 'pages/products/products/product-edit-collections.tag'
...
product-edit
    ...
    virtual(hide='{ loader }')
        ...
        ul.nav.nav-tabs.m-b-2
            ...
            li
                a(data-toggle='tab', href='#product-edit-prices', class="fa fa-cog", title="Цены")
                    span.hidden-xs  Цены
            li
                a(data-toggle='tab', href='#product-edit-collections', class="fa fa-list", title="Группы колллекций")
                    span.hidden-xs  Группы колллекций
            li
        ...
        .tab-content
                    ...
                    .row
                        ...
                        .col-md-6
                            .form-group.col-sm-2
                                ...
                                .checkbox
                                    label
                                        input(type='checkbox', name='isCollection', checked='{ item.isCollection }')
                                        | Сборный
                            .form-group.col-sm-2
                                label.hidden-xs &nbsp;
                                .checkbox
            ...
            #product-edit-collections.tab-pane.fade
                form(action='', onchange='{ change }', onkeyup='{ change }', method='POST')
                    product-edit-collections(name='collectionsGroups', value='{ item.collectionsGroups }')
