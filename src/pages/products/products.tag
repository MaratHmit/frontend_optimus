...
| import 'pages/products/collections/collections.tag'
| import 'pages/products/projects/projects.tag'
| import 'pages/products/projects/project-edit.tag'
...
products
    ...
    .column
        ...
        //collections(if='{ tab == "collections" }')
        ...
        projects(if='{ tab == "projects" && !edit }')
        project-edit(if='{ tab == "projects" && edit }')
    ...
    script(type='text/babel').
        ...
        self.tabs = [
            ...
            {title: 'Проекты', name: 'projects', link: 'projects', icon: 'fa fa-list', access: true},
            {title: 'Опции', name: 'options', link: 'options', icon: 'fa fa-list', access: true },
            // {title: 'Коллекции', name: 'collections', link: 'collections', icon: 'fa fa-list', access: true },
        ...
        route('/products/projects/new', tab => {
            self.update({edit: true, tab: 'projects'})
            observable.trigger('project-new')
        })
